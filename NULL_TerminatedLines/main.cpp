// C-строки или NULL_TerminatedLines
...
void main()
{
	...
	cout << "Строка в верхнем регистре: " << endl << to_upper(str) << endl;
	cout << "Строка в нижнем регистре: " << endl << to_lower(str) << endl;
	cout << "Строка без лишних пробелов: " << endl << shrink(str) << endl;
	cout << "Эта строка : " << ((is_palindrome(str))? "":"НЕ ") << "палиндром" << endl;
